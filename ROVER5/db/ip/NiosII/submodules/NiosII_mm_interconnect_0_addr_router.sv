...
module NiosII_mm_interconnect_0_addr_router_default_decode
  #(
...
module NiosII_mm_interconnect_0_addr_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    NiosII_mm_interconnect_0_addr_router_default_decode the_default_decode(
